...
async function deleteForm(formId) {
    return DELETE(`api/forms/${formId}`);
}
...
async function createQuestion(formId, sectionId, databody) {
    return POST(`api/forms/${formId}/sections/${sectionId}/questions`, databody);
}

async function deleteQuestion(formId, sectionId, questionId) {
    return DELETE(`api/forms/${formId}/sections/${sectionId}/questions/${questionId}`);
}

async function updateQuestion(formId, sectionId, databody) {
    return PATCH(`api/forms/${formId}/sections/${sectionId}/questions`, databody);
}
