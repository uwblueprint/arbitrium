        ...
        <CardContent>
          <CommentForm onSubmit={handleSubmit}>
            <FormControl variant="outlined" className="textFields">
              ...
              />
              <FormHelperText error={values.errorEmail}>{values.errorEmail ? errorEmailMessage : ''}</FormHelperText>
            </FormControl>
            <FormControl variant="outlined" className="textFields">
              ...
              />
              <FormHelperText error={values.errorPassword}>{values.errorPassword ? errorPasswordMessage : ''}</FormHelperText>
            </FormControl>
            <CardActions>
